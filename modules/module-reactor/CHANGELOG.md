...
- Updated dependencies [ce12daa]
  - @journeyapps/reactor-lib-data-layer@1.0.19
...
- ec60ac0: Unify required-field and nested-form checks under isValid(). Required text and selection fields reject blank values, required collections reject empty values, and hidden fields do not block validation. Preserve false and zero as supplied values.
...
- Updated dependencies [93dc52c]
  - @journeyapps/reactor-lib-data-layer@1.0.18
...
- Updated dependencies [d941ef6]
  - @journeyapps/reactor-lib-data-layer@1.0.17
...
- d84d25d: - Restore entity dragging from the command palette.
